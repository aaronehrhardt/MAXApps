...
@section('content')
    ...
    <div class="row-fluid">
        <div class="mix real-estate">
            <div class="card">
                <div class="card-image waves-effect waves-block waves-light"> <i class="fav-icon fa fa-heart fa-lg"></i> <a href="https://www.remax.net/Pages/default.aspx" target="_blank"><img class="activator" src="{{ asset('images/REMAX-Mainstreet-300x150.png') }}"></a> </div>
                ...
                <div class="card-reveal"><span class="card-title grey-text text-darken-4">Mainstreet <i class="mdi-navigation-close right"></i></span>
                    ...
                    <a class="btn btn-block btn-default" href="https://www.remax.net/Pages/default.aspx" target="_blank">Open App</a> </div>
            </div>
            <!-- end .card -->
        </div>
        <div class="mix commercial">
            <div class="card">
                <div class="card-image waves-effect waves-block waves-light"> <i class="fav-icon fa fa-heart fa-lg"></i> <a href="https://workforcenow.adp.com/public/index.htm" target="_blank"><img class="activator" src="{{ asset('images/ADP-logo-300x150.png') }}"></a> </div>
                ...
                <div class="card-reveal"><span class="card-title grey-text text-darken-4">ADP <i class="mdi-navigation-close right"></i></span>
                    <p>Here is some more information about this product that is only revealed once clicked on.</p>
                    <a class="btn btn-block btn-default" href="https://workforcenow.adp.com/public/index.htm" target="_blank">Open App</a> </div>
            </div>
            <!-- end .card -->
        </div>
        <div class="mix social">
            <div class="card">
                <div class="card-image waves-effect waves-block waves-light"> <i class="fav-icon fa fa-heart fa-lg"></i> <a href="http://www.remax.net/learn/Pages/MyRU.aspx" target="_blank"><img class="activator" src="{{ asset('images/REMAXU-logo-300x150.png') }}"></a> </div>
                ...
                <div class="card-reveal"><span class="card-title grey-text text-darken-4">RE/MAX University  <i class="mdi-navigation-close right"></i></span>
                    <p>Here is some more information about this product that is only revealed once clicked on.</p>
                    <a class="btn btn-block btn-default" href="http://www.remax.net/learn/Pages/MyRU.aspx" target="_blank">Open App</a> </div>
            </div>
            <!-- end .card -->
        </div>
        <div class="mix marketing">
            <div class="card">
                <div class="card-image waves-effect waves-block waves-light"> <i class="fav-icon fa fa-heart fa-lg"></i><a href="http://abovemag.remax.com/" target="_blank"> <img class="activator" src="{{ asset('images/ABOVE-logo-300x150.png') }}"></a> </div>
                ...
                <div class="card-reveal"><span class="card-title grey-text text-darken-4">ABOVE Magazine   <i class="mdi-navigation-close right"></i></span>
                    <p>Here is some more information about this product that is only revealed once clicked on.</p>
                    <a class="btn btn-block btn-default" href="http://abovemag.remax.com/" target="_blank">Open App</a> </div>
            </div>
            <!-- end .card -->
        </div>
        <div class="mix leads">
            <div class="card">
                <div class="card-image waves-effect waves-block waves-light"> <i class="fav-icon fa fa-heart fa-lg"></i> <a href="http://shop.remax.net/" target="_blank"><img class="activator" src="{{ asset('images/shop-logo-300x150.png') }}"></a> </div>
                ...
                <div class="card-reveal"><span class="card-title grey-text text-darken-4">Shop RE/MAX <i class="mdi-navigation-close right"></i></span>
                    <p>Here is some more information about this product that is only revealed once clicked on.</p>
                    <a class="btn btn-block btn-default" href="http://shop.remax.net/" target="_blank">Open App</a> </div>
            </div>
            <!-- end .card -->
        </div>
        <div class="mix luxury ">
            <div class="card">
                <div class="card-image waves-effect waves-block waves-light"> <i class="fav-icon fa fa-heart fa-lg"></i> <a href="http://home.remaxcommercial.com/" target="_blank"><img class="activator" src="{{ asset('images/commercial-logo-300x150.png') }}"></a> </div>
                ...
                <div class="card-reveal"><span class="card-title grey-text text-darken-4">RE/MAX Commercial <i class="mdi-navigation-close right"></i></span>
                    <p>Here is some more information about this product that is only revealed once clicked on.</p>
                    <a class="btn btn-block btn-default" href="http://home.remaxcommercial.com/" target="_blank">Open App</a> </div>
            </div>
            <!-- end .card -->
        </div>
        <div class="mix franchise ">
            <div class="card">
                <div class="card-image waves-effect waves-block waves-light"> <i class="fav-icon fa fa-heart fa-lg"></i> <a href="http://shop.remax.net/" target="_blank"><img class="activator" src="{{ asset('images/TRMC-logo-300x150.png') }}"></a> </div>
        ...
        <div class="mix referrals ">
            <div class="card">
                <div class="card-image waves-effect waves-block waves-light"> <i class="fav-icon fa fa-heart fa-lg"></i> <a href="http://www.remax-franchise.com/" target="_blank"><img class="activator" src="{{ asset('images/franchise-logo-300x150.png') }}"></a> </div>
                ...
                <div class="card-reveal"><span class="card-title grey-text text-darken-4">RE/MAX Franchise <i class="mdi-navigation-close right"></i></span>
                    <p>Here is some more information about this product that is only revealed once clicked on.</p>
                    <a class="btn btn-block btn-default" href="http://www.remax-franchise.com/" target="_blank">Open App</a> </div>
            </div>
            <!-- end .card -->
        </div>
        <div class="mix websites ">
            <div class="card">
                <div class="card-image waves-effect waves-block waves-light"> <i class="fav-icon fa fa-heart fa-lg"></i> <a href="http://www.remax.net/recruit/Pages/DestinationRemax.aspx" target="_blank"><img class="activator" src="{{ asset('images/destination-logo-300x150.png') }}"></a> </div>
                ...
                <div class="card-reveal"><span class="card-title grey-text text-darken-4">Destination RE/MAX<i class="mdi-navigation-close right"></i></span>
                    <p>Here is some more information about this product that is only revealed once clicked on.</p>
                    <a class="btn btn-block btn-default" href="http://www.remax.net/recruit/Pages/DestinationRemax.aspx" target="_blank">Open App</a> </div>
            </div>
            <!-- end .card -->
        </div>
        <div class="mix real-estate ">
            <div class="card">
                <div class="card-image waves-effect waves-block waves-light"> <i class="fav-icon fa fa-heart fa-lg"></i> <a href="http://www.remax.net/events/conventions/Pages/conventions.aspx" target="_blank"><img class="activator" src="{{ asset('images/r4-logo-300x150.png') }}"></a> </div>
                ...
                <div class="card-reveal"><span class="card-title grey-text text-darken-4">R4 Convention<i class="mdi-navigation-close right"></i></span>
                    <p>Here is some more information about this product that is only revealed once clicked on.</p>
                    <a class="btn btn-block btn-default" href="http://www.remax.net/events/conventions/Pages/conventions.aspx" target="_blank">Open App</a> </div>
            </div>
            <!-- end .card -->
        </div>
        <div class="mix commercial ">
            <div class="card">
                <div class="card-image waves-effect waves-block waves-light"> <i class="fav-icon fa fa-heart fa-lg"></i><a href="http://www.edrtravel.com/" target="_blank"> <img class="activator" src="{{ asset('images/edr-logo-300x150.png') }}"></a> </div>
                ...
                <div class="card-reveal"><span class="card-title grey-text text-darken-4">EDR Travel<i class="mdi-navigation-close right"></i></span>
                    <p>Here is some more information about this product that is only revealed once clicked on.</p>
                    <a class="btn btn-block btn-default" href="http://www.edrtravel.com/" target="_blank">Open App</a> </div>
            </div>
            <!-- end .card -->
        </div>
        <div class="mix social ">
            <div class="card">
                <div class="card-image waves-effect waves-block waves-light"> <i class="fav-icon fa fa-heart fa-lg"></i> <a href="http://www.remaxesp.com/comp_int/?Token=6NnV3ui2OnvLyHDOGOxcE5wMikRA5ABMDUZL5YDwoSM%3d" target="_blank"><img class="activator" src="{{ asset('images/ci-logo-300x150.png') }}"> </a></div>
                ...
                <div class="card-reveal"><span class="card-title grey-text text-darken-4">Competitive Intel<i class="mdi-navigation-close right"></i></span>
                    <p>Here is some more information about this product that is only revealed once clicked on.</p>
                    <a class="btn btn-block btn-default" href="http://www.remaxesp.com/comp_int/?Token=6NnV3ui2OnvLyHDOGOxcE5wMikRA5ABMDUZL5YDwoSM%3d" target="_blank">Open App</a> </div>
            </div>
            <!-- end .card -->
        </div>
        <div class="mix real-estate">
